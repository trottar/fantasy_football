...
| M3 procedure/ownership cleanup | ACTIVE / SUBDIVIDED | Yes for M4 until M3A and M3B are both durable | M3A reconciles procedure ownership/delivery wording; M3B separately cleans curated `MEMORY.md` role drift |
...
| Week 3 week-open capture | UPCOMING HARD CALENDAR GATE | Yes for causal 2026 measurement quality | Freeze prospective state before the first Week 3 game; do not delay for nonessential M3B-M7 or Phase 1B work |
