...
| M5 startup contract | CONTENT COMPLETE | Yes for M6 until M5 is durable | Publish the reviewed M5 startup-contract decision; M6 may enforce but not redesign the selected contract |
...
| Week 3 week-open capture | UPCOMING HARD CALENDAR GATE | Yes for causal 2026 measurement quality | Freeze prospective state before the first Week 3 game; do not delay for nonessential M6-M7 or Phase 1B work |
