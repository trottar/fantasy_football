...
<!-- FANTASY_D011_V036_REPACK1:BEGIN -->
## Decision

Use `v0.36-repack1` strictly as an artifact/repack label, not a new model version and not a historical fixed1.

The repaired artifact is exact validated v0.36 plus the four missing public mock-calibration fixtures. The source is durably imported. Automated GUI validation is mandatory and passed. Live browser GUI commissioning remains mandatory before v1.0A.
